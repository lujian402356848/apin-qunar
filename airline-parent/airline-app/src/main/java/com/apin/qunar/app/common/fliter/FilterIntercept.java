...
public class FilterIntercept implements Filter {
    ...
    private static final Set<String> ALLOWED_PATHS = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("/qufei/merchant/register", "/qufei/user/register", "/qufei/user/login", "/qufei/alipay/payCallback", "/qufei/wechatPay/payCallback", "/qunar/order/statusCallback", "/qunar/ntsOrder/statusCallback", "/api/pay/callback", "/api/refund/callback", "/qufei/flightChange/callback", "/qufei/ntsFlightChange/callback")));
