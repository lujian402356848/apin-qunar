...
public class NtsSearchOrderListController extends BaseController {
    ...
    public GeneralResultMap searchOrderList(@RequestBody NtsSearchOrderListRequest request) {
        ...
        try {
            List<InternationalOrderVO> nationalOrderList = ntsSearchOrderListService.queryPageList(request.getMerchantNo(), request.getAccount(), request.getOrderNo(), request.getPessengerName(), request.getOffset(), request.getLimit());
